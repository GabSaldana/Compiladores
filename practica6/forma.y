...
import javax.swing.*;
%}
%token NUMBER LINE RIGHT CIRCULO COLOR PRINT RECTANGULO VARIABLE MOVERF DIBUJARF IF IGUAL END ENTERO PRINTF LOOP MENOR MAYOR FOR
%start list
%%
list :
     | list ';'
     ...
     | list cicloif {maq.code("STOP"); return 1 ;}   
     ;

cicloif: for '(' stmfor ';' condicion ';' stmfor ')' stm end {
      $$ = new ParserVal(new Algo(new Integer(((Algo)$1.obj).inst)));
      maq.getProg().setElementAt( new Integer(((Algo)$5.obj).inst), ((Algo)$1.obj).inst+1);
      maq.getProg().setElementAt( new Integer(((Algo)$7.obj).inst), ((Algo)$1.obj).inst+2);
      maq.getProg().setElementAt( new Integer(((Algo)$9.obj).inst), ((Algo)$1.obj).inst+3);
      maq.getProg().setElementAt( new Integer(((Algo)$10.obj).inst), ((Algo)$1.obj).inst+4);
      }
      ;
...
expresion: NUMBER   { ((Algo)$$.obj).inst=maq.code("constpush");maq.code(((Algo)$1.obj).simb); }
          ...
          |expresion IGUAL expresion {maq.code("igual");
           $$ = new ParserVal(new Algo(new Integer(((Algo)$1.obj).inst)));}
          |expresion MENOR expresion {maq.code("menor");
           $$ = new ParserVal(new Algo(new Integer(((Algo)$1.obj).inst)));}
          |expresion MAYOR expresion {maq.code("mayor");
           $$ = new ParserVal(new Algo(new Integer(((Algo)$1.obj).inst)));}
          ;

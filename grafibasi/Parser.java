...
final static short yysindex[] = {                         0,
  -59,    0, -256, -255, -254, -253,    0,  -54, -251, -250,
    0, -249,    0, -248, -247, -246, -245, -244, -243, -242,
 -241, -240, -239,    0, -237,    0,    0,
};
...
yycheck = new short[] {                         59,
  ...
  257,  257,   -1,  257,   -1,  257,  261,  257,  261,  257,
...
"list : list inst ';'",
"inst : NUMBER",
"inst : LINE NUMBER NUMBER NUMBER NUMBER COLOR NUMBER",
"inst : CIRCULO NUMBER NUMBER NUMBER COLOR NUMBER",
"inst : RECTANGULO NUMBER NUMBER NUMBER NUMBER COLOR NUMBER",
"inst : COLOR NUMBER",
};
...
class ManejaBoton implements ActionListener {
   ...
   public void actionPerformed(ActionEvent e){
      ...
      if(jb == bcalc){
         ...
         System.out.println("MAQQ: " + maq.getProg().size());

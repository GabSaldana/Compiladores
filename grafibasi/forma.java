...
/* "forma.java":44  */ /* lalr1.java:91  */

/* "forma.java":46  */ /* lalr1.java:92  */

/**
 * A Bison parser, automatically generated from <tt>forma.y</tt>.
 *
...
/* Tokens.  */
    ...
    /** Token number,to be returned by the scanner.  */
    static final int LINE = 259;
    /** Token number,to be returned by the scanner.  */
    static final int RIGHT = 260;
    /** Token number,to be returned by the scanner.  */
    static final int CIRCULO = 261;
    /** Token number,to be returned by the scanner.  */
    static final int COLOR = 262;
    /** Token number,to be returned by the scanner.  */
    static final int PRINT = 263;
  ...
  case 5:
  if (yyn == 5)
    /* "forma.y":20  */ /* lalr1.java:489  */
    { ((Algo)yyval.obj).inst=maq.code("constpush");
                maq.code(((Algo)((yystack.valueAt (1-(1)))).obj).simb); };
  break;
    

  case 6:
  if (yyn == 6)
    /* "forma.y":22  */ /* lalr1.java:489  */
    { maq.code("constpush");
                maq.code(((Algo)((yystack.valueAt (2-(2)))).obj).simb); maq.code("line");};
  break;
    

  case 7:
  if (yyn == 7)
    /* "forma.y":24  */ /* lalr1.java:489  */
    { maq.code("constpush");
                maq.code(((Algo)((yystack.valueAt (2-(2)))).obj).simb); maq.code("circulo");};
  break;
    

  case 8:
  if (yyn == 8)
    /* "forma.y":26  */ /* lalr1.java:489  */
    { maq.code("constpush");
                maq.code(((Algo)((yystack.valueAt (2-(2)))).obj).simb); maq.code("color");};
  break;
    


/* "forma.java":365  */ /* lalr1.java:489  */
        default: break;
      }
...
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
  ...
  private static final String[] yytname_init()
  {
    return new String[]
    {
  "$end", "error", "$undefined", "NUMBER", "LINE", "RIGHT", "CIRCULO",
  "COLOR", "PRINT", "';'", "$accept", "list", "inst", null
    };
  }
